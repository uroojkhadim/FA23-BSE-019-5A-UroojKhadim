  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        unselectedItemColor: widget.isDarkMode ? Colors.white70 : Colors.black54,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Divider(),
                    ListTile(
                      title: Text('Export Tasks to CSV'),
                    ...
                    Divider(),
                    ListTile(
                      title: Text('Export Tasks to Excel'),
                      subtitle: Text('Export all tasks to Excel file'),
                      trailing: Icon(Icons.file_upload),
                      onTap: _exportTasksToExcel,
                    ),
                  ],
                ),
              ),

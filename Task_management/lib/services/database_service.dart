...
class DatabaseService {
  ...
  Future<void> _upgradeDB(Database db, int oldVersion, int newVersion) async {
    ...
    if (oldVersion < 3) {
      // Add due time columns
      await db.execute('ALTER TABLE tasks ADD COLUMN dueTimeHour INTEGER');
      await db.execute('ALTER TABLE tasks ADD COLUMN dueTimeMinute INTEGER');
    }
  }
